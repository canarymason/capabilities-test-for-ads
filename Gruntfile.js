  ...
  grunt.initConfig({
    ...
    concat: {
      rb: {
        ...
        files: {
          '.compass/lib/oxygen-style-guide.rb': ['.compass/.template/style-guide.rb']
        }
      },
      gemspec: {
        options: {
        ...
        files: {
          '.compass/oxygen-style-guide.gemspec': ['.compass/.template/style-guide.gemspec']
        }
      }
    },
    ...
    exec: {
      ...
      ext: {
        cmd: 'cd .compass && bundle exec gem build oxygen-style-guide.gemspec && mv oxygen-style-guide-' + userConfig.client.version + '.gem ../oxygen-style-guide-' + userConfig.client.version + '.gem && cd ..'
      },
      install: {
        cmd: 'gem install oxygen-style-guide-' + userConfig.client.version + '.gem && rm oxygen-style-guide-' + userConfig.client.version + '.gem'
      },
      weinre: {
